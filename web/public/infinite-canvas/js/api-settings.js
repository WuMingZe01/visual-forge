...
function rhEntryThumbnailCandidates(kind, entry){
    ...
    const roots = ['/infinite-canvas/runninghub/thumbnails', '/infinite-canvas/runninghub'];
    const urls = [];
    names.forEach(name => {
        exts.forEach(ext => {
        ...
        if(item.id === 'modelscope'){
            return `
                <button class="provider-card provider-card-banner ${active}" type="button" onclick="selectProvider('${escapeHtml(item.id)}')">
                    <img src="/infinite-canvas/images/modelscope.gif" alt="ModelScope" class="ms-icon-light">
                    <img src="/infinite-canvas/images/modelscope-1.gif" alt="ModelScope" class="ms-icon-dark">
                </button>
            `;
        }
        if(item.id === 'runninghub'){
            return `
                <button class="provider-card provider-card-banner ${active}" type="button" onclick="selectProvider('${escapeHtml(item.id)}')">
                    <img src="/infinite-canvas/images/RunningHub-B.png" alt="RunningHub" class="runninghub-icon ms-icon-light">
                    <img src="/infinite-canvas/images/RunningHub-W.png" alt="RunningHub" class="runninghub-icon ms-icon-dark">
                </button>
            `;
        }
        return `
